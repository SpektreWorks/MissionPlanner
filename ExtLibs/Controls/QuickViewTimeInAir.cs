...
{
    public partial class QuickViewTimeInAir : SkiaSharp.Views.Desktop.SKControl
    {
        ...
        private void OnPaintSurface(object sender, SKPaintSurfaceEventArgs e2)
        {
...

            {
                ...
                Size extent = e.MeasureString(str, new Font(this.Font.FontFamily, (float)newSize, this.Font.Style)).ToSize();
                e.DrawString(str, new Font(this.Font.FontFamily, (float)numFontSize, this.Font.Style), new SolidBrush(this.strColor), (this.Width / 2 - extent.Width / 2)-4, y + ((this.Height - y) / 2 - extent.Height / 2));
            }
        }
